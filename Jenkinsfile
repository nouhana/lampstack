...
node {
    ...
    stage 'Build & UnitTest'
        sh "docker build -t dockerpvregistry.azurecr.io/hello-world/dockerstack_php_apache:B${BUILD_NUMBER} -f ./dockerstack/Dockerfile ."
        sh "docker build -t dockerpvregistry.azurecr.io/hello-world/dockerstack_db:db-B${BUILD_NUMBER} -f ./dockerstack/mysql.Dockerfile ."
