...
node {
    ...
    stage 'Build & UnitTest'
        sh "docker build -t registry.gitlab.com/registry12/dockerstack_php_apache:B${BUILD_NUMBER} -f ./dockerstack/Dockerfile ."
        sh "docker build -t registry.gitlab.com/registry12/dockerstack_db:db-B${BUILD_NUMBER} -f ./dockerstack/mysql.Dockerfile ."
